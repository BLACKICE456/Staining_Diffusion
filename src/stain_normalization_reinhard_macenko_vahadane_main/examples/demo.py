...
input_dir = './data/'
output_dir = '/mnt/data/result_ge47nej/results_translation_test/512_imagesize'

#%% load data
for img in range(4):
    img_target = utils.read_image("/mnt/data/result_ge47nej/results_translation_test/512_imagesize/00600_test_3+.png")
    img_source_1 = utils.read_image("/mnt/data/result_ge47nej/results_translation_test/512_imagesize/00600_test_3+.png")
    ...
    normalized=utils.build_stack((img_target, img_source_1 , normalizer.transform(img_source_1)))
