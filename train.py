...
if condition:
    ...
    if input_condition:
        ...
        folder = [r"D:\paper_model\BCI\BCI_dataset\HE\train",
                  r"D:\paper_model\BCI\BCI_dataset\IHC\train",
                  r"D:\paper_model\BCI\BCI_dataset\HE\test",
                  r"D:\paper_model\BCI\BCI_dataset\IHC\test"]
    train_batch_size = 2
    num_samples = 4
    sum_scale = 0.01
    image_size = 256
